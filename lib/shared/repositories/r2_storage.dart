...
/// Credentials configured via --dart-define
class R2StorageService {
  ...
  static Future<String> uploadFile({
    ...
    final canonicalUri = '/$_bucket/$path';
    ...
    final authHeader = 'AWS4-HMAC-SHA256 Credential=$_accessKeyId/$credentialScope, SignedHeaders=$signedHeaders, Signature=$signature';

    final endpointUrl = Uri.parse('https://$host/$_bucket/$path');
